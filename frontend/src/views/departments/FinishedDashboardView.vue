...
<template>
  <main class="dashboard-page">
    <header class="dashboard-header">
      <div>
        <div class="page-kicker">成品部门</div>
        <h1>成品工作台</h1>
      </div>
      <nav class="header-actions" aria-label="成品导航">
        <ElButton @click="router.push('/dashboard')">产品总览</ElButton>
        <ElButton class="nav-current" type="primary" aria-current="page">成品工作台</ElButton>
        <ElButton @click="switchUser">切换用户</ElButton>
      </nav>
    </header>
    <section class="empty-panel">
      <ElEmpty description="成品部门功能待开发" />
    </section>
  </main>
</template>
