...
from modules.standard_execution.persistence import ProcedureTagSet
from modules.standard_execution.persistence import ProcedureTagStock
from modules.errors import DomainError
from modules.standard_execution.tags import tag_set_tags
from modules.production_core.operational_api import InventorySource
...
def validate_tag_source(
    ...
    if not isinstance(source, ProcedureTagStock):
        return None
