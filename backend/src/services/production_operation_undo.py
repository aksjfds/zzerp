...
def serialize_undo_operation(operation: ProductionOperationUndo | None) -> dict | None:
...
def latest_undoable_operation(session, work_order_id: int) -> ProductionOperationUndo | None:
